...
func FinancialGLAccountsPrimaryPropertySample() *int64 {
	v := int64(100)
	return &v
}

func FinancialGLAccountsEntityWithPopulatedPrimaryProperty() *FinancialGLAccounts {
	return &FinancialGLAccounts{Timestamp: FinancialGLAccountsPrimaryPropertySample()}
}

func FinancialGLAccountsStringOfPrimaryProperty(v *int64) string {
	return strconv.Itoa(int(*v))
}

func FinancialGLAccountsStringJSONOfPrimaryProperty(v *int64) string {
	b, _ := json.Marshal(v)
	return string(b)
}
...
func TestFinancialGLAccountsEndpoint_GetPrimary(t *testing.T) {
	var want int64
	n := &FinancialGLAccounts{Timestamp: &want}
...
func TestFinancialGLAccountsEndpoint_List_all(t *testing.T) {
	...
	opts1.Select.Add("*")
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/Financial/GLAccounts", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in FinancialGLAccountsEndpoint.List returned error: %v, with url /api/v1/{division}/sync/Financial/GLAccounts?$select=*", e)
	}
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/Financial/GLAccounts", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in FinancialGLAccountsEndpoint.List returned error: %v, with url /api/v1/{division}/sync/Financial/GLAccounts?$skiptoken=foo", e2)
	}
	...
	want := []*FinancialGLAccounts{{Timestamp: g}}
...
func TestFinancialGLAccountsEndpoint_List(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/Financial/GLAccounts", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in FinancialGLAccountsEndpoint.List returned error: %v, with url /api/v1/{division}/sync/Financial/GLAccounts", e)
	}
	api.AddListOptionsToURL(u, opts1)
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/Financial/GLAccounts", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in FinancialGLAccountsEndpoint.List returned error: %v, with url /api/v1/{division}/sync/Financial/GLAccounts", e2)
	}
	api.AddListOptionsToURL(u2, opts2)
...
func TestFinancialGLAccountsEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&FinancialGLAccounts{Timestamp: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/Financial/GLAccounts", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in FinancialGLAccountsEndpoint.Delete() returned error: %v, with url /api/v1/{division}/sync/Financial/GLAccounts", e)
			}
