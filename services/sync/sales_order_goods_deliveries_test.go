...
func SalesOrderGoodsDeliveriesPrimaryPropertySample() *int64 {
	v := int64(100)
	return &v
}

func SalesOrderGoodsDeliveriesEntityWithPopulatedPrimaryProperty() *SalesOrderGoodsDeliveries {
	return &SalesOrderGoodsDeliveries{Timestamp: SalesOrderGoodsDeliveriesPrimaryPropertySample()}
}

func SalesOrderGoodsDeliveriesStringOfPrimaryProperty(v *int64) string {
	return strconv.Itoa(int(*v))
}

func SalesOrderGoodsDeliveriesStringJSONOfPrimaryProperty(v *int64) string {
	b, _ := json.Marshal(v)
	return string(b)
}
...
func TestSalesOrderGoodsDeliveriesEndpoint_GetPrimary(t *testing.T) {
	var want int64
	n := &SalesOrderGoodsDeliveries{Timestamp: &want}
...
func TestSalesOrderGoodsDeliveriesEndpoint_List_all(t *testing.T) {
	...
	opts1.Select.Add("*")
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveries", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveriesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveries?$select=*", e)
	}
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveries", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveriesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveries?$skiptoken=foo", e2)
	}
	...
	want := []*SalesOrderGoodsDeliveries{{Timestamp: g}}
...
func TestSalesOrderGoodsDeliveriesEndpoint_List(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveries", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveriesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveries", e)
	}
	api.AddListOptionsToURL(u, opts1)
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveries", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveriesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveries", e2)
	}
	api.AddListOptionsToURL(u2, opts2)
...
func TestSalesOrderGoodsDeliveriesEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&SalesOrderGoodsDeliveries{Timestamp: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveries", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveriesEndpoint.Delete() returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveries", e)
			}
