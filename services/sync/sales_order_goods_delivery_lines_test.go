...
func SalesOrderGoodsDeliveryLinesPrimaryPropertySample() *int64 {
	v := int64(100)
	return &v
}

func SalesOrderGoodsDeliveryLinesEntityWithPopulatedPrimaryProperty() *SalesOrderGoodsDeliveryLines {
	return &SalesOrderGoodsDeliveryLines{Timestamp: SalesOrderGoodsDeliveryLinesPrimaryPropertySample()}
}

func SalesOrderGoodsDeliveryLinesStringOfPrimaryProperty(v *int64) string {
	return strconv.Itoa(int(*v))
}

func SalesOrderGoodsDeliveryLinesStringJSONOfPrimaryProperty(v *int64) string {
	b, _ := json.Marshal(v)
	return string(b)
}
...
func TestSalesOrderGoodsDeliveryLinesEndpoint_GetPrimary(t *testing.T) {
	var want int64
	n := &SalesOrderGoodsDeliveryLines{Timestamp: &want}
...
func TestSalesOrderGoodsDeliveryLinesEndpoint_List_all(t *testing.T) {
	...
	opts1.Select.Add("*")
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveryLinesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines?$select=*", e)
	}
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveryLinesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines?$skiptoken=foo", e2)
	}
	...
	want := []*SalesOrderGoodsDeliveryLines{{Timestamp: g}}
...
func TestSalesOrderGoodsDeliveryLinesEndpoint_List(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveryLinesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", e)
	}
	api.AddListOptionsToURL(u, opts1)
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveryLinesEndpoint.List returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", e2)
	}
	api.AddListOptionsToURL(u2, opts2)
...
func TestSalesOrderGoodsDeliveryLinesEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&SalesOrderGoodsDeliveryLines{Timestamp: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in SalesOrderGoodsDeliveryLinesEndpoint.Delete() returned error: %v, with url /api/v1/{division}/sync/SalesOrder/GoodsDeliveryLines", e)
			}
