...
// CashflowReceivablesEndpoint is responsible for communicating with
// the CashflowReceivables endpoint of the Bulk service.
type CashflowReceivablesEndpoint service

// CashflowReceivables:
// Service: Bulk
// Entity: CashflowReceivables
// URL: /api/v1/{division}/bulk/Cashflow/Receivables
// HasWebhook: false
// IsInBeta: false
// Methods: GET
// Endpoint docs: https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=BulkCashflowReceivables
...
func (e *CashflowReceivables) GetPrimary() *types.GUID {
	return e.ID
}

func (s *CashflowReceivablesEndpoint) UserHasRights(ctx context.Context, division int, method string) (bool, error) {
	return s.client.UserHasRights(ctx, division, "Cashflow/Receivables", method)
}

// List the CashflowReceivables entities in the provided division.
// If all is true, all the paginated results are fetched; if false, list the first page.
func (s *CashflowReceivablesEndpoint) List(ctx context.Context, division int, all bool, o *api.ListOptions) ([]*CashflowReceivables, error) {
	var entities []*CashflowReceivables
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/Cashflow/Receivables", division) // #nosec
...
// Get the CashflowReceivables entitiy in the provided division.
func (s *CashflowReceivablesEndpoint) Get(ctx context.Context, division int, id *types.GUID) (*CashflowReceivables, error) {
	b, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/Cashflow/Receivables", division) // #nosec
	u, err := api.AddOdataKeyToURL(b, id)
	if err != nil {
		return nil, err
	}

	e := &CashflowReceivables{}
