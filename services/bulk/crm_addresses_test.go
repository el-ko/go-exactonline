...
func CRMAddressesPrimaryPropertySample() *types.GUID {
	v := types.NewGUID()
	return &v
}

func CRMAddressesEntityWithPopulatedPrimaryProperty() *CRMAddresses {
	return &CRMAddresses{ID: CRMAddressesPrimaryPropertySample()}
}

func CRMAddressesStringOfPrimaryProperty(v *types.GUID) string {
	return v.String()
}

func CRMAddressesStringJSONOfPrimaryProperty(v *types.GUID) string {
	b, _ := json.Marshal(v)
	return string(b)
}
...
func TestCRMAddressesEndpoint_List_all(t *testing.T) {
	...
	opts1.Select.Add("*")
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/CRM/Addresses", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in CRMAddressesEndpoint.List returned error: %v, with url /api/v1/{division}/bulk/CRM/Addresses?$select=*", e)
	}
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/CRM/Addresses", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in CRMAddressesEndpoint.List returned error: %v, with url /api/v1/{division}/bulk/CRM/Addresses?$skiptoken=foo", e2)
	}
...
func TestCRMAddressesEndpoint_List(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/CRM/Addresses", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in CRMAddressesEndpoint.List returned error: %v, with url /api/v1/{division}/bulk/CRM/Addresses", e)
	}
	api.AddListOptionsToURL(u, opts1)
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/CRM/Addresses", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in CRMAddressesEndpoint.List returned error: %v, with url /api/v1/{division}/bulk/CRM/Addresses", e2)
	}
	api.AddListOptionsToURL(u2, opts2)
...
func TestCRMAddressesEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&CRMAddresses{ID: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/CRM/Addresses", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in CRMAddressesEndpoint.Delete() returned error: %v, with url /api/v1/{division}/bulk/CRM/Addresses", e)
			}
