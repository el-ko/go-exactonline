...
// the SalesOrderGoodsDeliveryLines endpoint of the Bulk service.
...
// IsInBeta: false
// Methods: GET
// Endpoint docs: https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=BulkSalesOrderGoodsDeliveryLines
...
func (e *SalesOrderGoodsDeliveryLines) GetPrimary() *types.GUID {
	return e.ID
}
...
func (s *SalesOrderGoodsDeliveryLinesEndpoint) List(ctx context.Context, division int, all bool, o *api.ListOptions) ([]*SalesOrderGoodsDeliveryLines, error) {
	...
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/SalesOrder/GoodsDeliveryLines", division) // #nosec
...
func (s *SalesOrderGoodsDeliveryLinesEndpoint) Get(ctx context.Context, division int, id *types.GUID) (*SalesOrderGoodsDeliveryLines, error) {
	b, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/SalesOrder/GoodsDeliveryLines", division) // #nosec
